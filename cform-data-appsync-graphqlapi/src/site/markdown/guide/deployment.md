...
Resources:
    LogGroup:
        ...
        Properties:
            LogGroupName: "/aws/cloudformation/type/WrzasqPl-AppSync-GraphQlApiData/"
            RetentionInDays: 14
    ...
    AppSyncGraphQlApiDataHandler:
        ...
        Properties:
            ...
            SchemaHandlerPackage: "s3://your-bucket-name/wrzasqpl-appsync-graphqlapidata.zip"
            TypeName: "WrzasqPl::AppSync::GraphQlApiData"

    AppSyncGraphQlApiDataVersion:
        Type: "AWS::CloudFormation::ResourceDefaultVersion"
        Properties:
            TypeVersionArn: !Ref "AppSyncGraphQlApiDataHandler"
```
