...
import pl.wrzasq.cform.resource.aws.account.model.toDeleteRequest
...
class DeleteHandler(
    ...
    override fun handleRequest(
        ...
        return ProgressEvent.progress(
            ...
            .then {
                proxy.initiate(
                    "WrzasqPl-AWS-Account::Delete::PreDeletionCheck",
                    proxyClient,
                    it.resourceModel,
                    it.callbackContext
                )
                    ...
                    .makeServiceCall { awsRequest, client ->
                        ...
                        val realId = response.account().id()
                        ...
                        if (realId != physicalId) {
                            throw CfnResourceConflictException(
                                ...
                                "Can not delete Account - ID $realId doesn't match CloudFormation-provided" +
                    ...
                    .makeServiceCall { awsRequest, client ->
                        try {
                            client.injectCredentialsAndInvokeV2(
                                awsRequest,
                                client.client()::removeAccountFromOrganization
                            ).also {
