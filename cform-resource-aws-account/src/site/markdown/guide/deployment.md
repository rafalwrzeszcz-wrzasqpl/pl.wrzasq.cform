...
You need to upload packaged resource handler (`wrzasqpl-aws-account.zip` from
...
Resources:
    LogGroup:
        ...
        Properties:
            LogGroupName: "/aws/cloudformation/type/WrzasqPl-AWS-Account/"
            RetentionInDays: 14
    ...
    AccountHandler:
        ...
        Properties: 
            ...
            SchemaHandlerPackage: "s3://your-bucket-name/wrzasqpl-aws-account.zip"
            TypeName: "WrzasqPl::AWS::Account"

    AccountVersion:
        Type: "AWS::CloudFormation::ResourceDefaultVersion"
        Properties: 
            TypeVersionArn: !Ref "AccountHandler"
```
